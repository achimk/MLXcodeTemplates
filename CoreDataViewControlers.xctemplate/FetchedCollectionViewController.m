...
#import "___VARIABLE_classPrefix:identifier___FetchedCollectionViewController.h"

#pragma mark - ___VARIABLE_classPrefix:identifier___FetchedCollectionViewController

@interface ___VARIABLE_classPrefix:identifier___FetchedCollectionViewController () {
    BOOL _needsFetch;
...
@implementation ___VARIABLE_classPrefix:identifier___FetchedCollectionViewController
...
- (void)controllerWillChangeContent:(NSFetchedResultsController *)controller {
    switch (self.changeType) {
        case ___VARIABLE_classPrefix:identifier___ChangeTypeUpdate: {
            _updateAnimated = YES;
            break;
        }
        case ___VARIABLE_classPrefix:identifier___ChangeTypeIgnore:
        case ___VARIABLE_classPrefix:identifier___ChangeTypeReload:
        default: {
            break;
        }
    }
...
- (void)controllerDidChangeContent:(NSFetchedResultsController *)controller {
    ...
    else if (___VARIABLE_classPrefix:identifier___ChangeTypeReload == self.changeType) {
        if (self.isViewVisible) {
            [self reloadData];
        }
        else {
