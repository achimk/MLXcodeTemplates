...
@interface ___VARIABLE_classPrefix:identifier___FetchedViewController : ___VARIABLE_classPrefix:identifier___ViewController <NSFetchedResultsControllerDelegate>
...
@interface ___VARIABLE_classPrefix:identifier___FetchedViewController (___VARIABLE_classPrefix:identifier___SubclassOnly)
