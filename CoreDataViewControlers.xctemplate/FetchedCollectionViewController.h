...
@interface ___VARIABLE_classPrefix:identifier___FetchedCollectionViewController : ___VARIABLE_classPrefix:identifier___CollectionViewController <NSFetchedResultsControllerDelegate>
...
@interface ___VARIABLE_classPrefix:identifier___FetchedCollectionViewController (___VARIABLE_classPrefix:identifier___SubclassOnly)
